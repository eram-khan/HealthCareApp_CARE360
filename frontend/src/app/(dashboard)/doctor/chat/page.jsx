            ...
            <div className="md:col-span-1">
              <Card className="h-[600px] flex flex-col shadow-lg border">
                ...
                <div className="flex-1 overflow-y-auto p-2 space-y-2">
                  ...
                  contacts.length === 0 ?
                  <div className="text-center text-sm text-gray-500 p-4 mt-2">No recent chats.</div> :
            ...
            <div className="md:col-span-3">
              ...
              <Card className="h-[600px] flex items-center justify-center shadow-lg border bg-white">
                  <CardContent className="text-center">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Patient Messages</h3>
                    <p className="text-gray-500 max-w-sm mx-auto">
                      Select a conversation from the sidebar to chat with your patients.
                    </p>
                  </CardContent>
                </Card>
              }
